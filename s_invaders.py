...
#            SPACE_INVADERS                                  # 
#                                                            #
#     Author: James Lu ver.17                                #
#                                                            #
#     Description: A python based game utilizing pygame,     #                            
#     this version of space invaders plays out like the      #
#     original, with points given for kills and the          #
#     game over when the aliens hitting the spaceship.       #
...
pygame.display.set_caption("Welcome to Space Invaders Game by:- James ")
...
player_Xchange = 0
#invader
invaderImage = pygame.image.load('images\\ailen.png')
invader_X = []
invader_Y = []
invader_Xchange = []
invader_Ychange = []
...
def player(x, y):
    screen.blit(playerImage, (round(x - 16), round(y + 10)))
  
def invader(x, y):
    screen.blit(invaderImage, (round(x), round(y)))
